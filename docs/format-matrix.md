...
| Operation | Notes |
|---|---|
| Resize | Operation `image:resize`; Web, Service and Local Agent; width/height with fit modes (cover, contain, fill, inside, outside). |
| Convert | Operation `image:convert`; Service and Local Agent; output formats JPEG, PNG, WebP, AVIF and TIFF. |
| Rotate | 90°, 180°, 270° |
