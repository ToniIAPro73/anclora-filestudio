...
const PDF_OPERATIONS: OperationDefinition[] = [
  ...
  },
  {
    id: "pdf:extract-text",
    category: "pdf",
    labelKey: "op.pdf.extract-text",
    descriptionKey: "op.pdf.extract-text.desc",
    inputFormats: ["pdf"],
    outputFormats: ["txt"],
    engineId: "poppler",
  ...
  },
  {
    id: "pdf:extract-html",
    category: "pdf",
    labelKey: "op.pdf.extract-html",
    descriptionKey: "op.pdf.extract-html.desc",
    inputFormats: ["pdf"],
    outputFormats: ["html"],
    engineId: "poppler",
    dependencies: ["pdftohtml"],
  ...
  {
    id: "pdf:extract-markdown",
    category: "pdf",
    labelKey: "op.pdf.extract-markdown",
    descriptionKey: "op.pdf.extract-markdown.desc",
    inputFormats: ["pdf"],
    outputFormats: ["md"],
    engineId: "poppler",
    dependencies: ["pdftohtml", "pandoc"],
    lossProfile: "structural-risk",
    mobilePortability: "desktop-only",
    resourceProfile: "low",
    supportsBatch: true,
...
const IMAGE_OPERATIONS: OperationDefinition[] = [
  ...
  },
  {
    id: "image:to-pdf",
    category: "image",
    labelKey: "op.image.to-pdf",
    descriptionKey: "op.image.to-pdf.desc",
    inputFormats: ["jpeg", "jpg", "png", "webp", "tiff"],
    outputFormats: ["pdf"],
    engineId: "sharp-image",
    dependencies: ["sharp"],
    lossProfile: "lossy-controlled",
...
const DOCUMENT_OPERATIONS: OperationDefinition[] = [
  ...
  {
    id: "render:html-to-image",
    category: "document",
    labelKey: "op.render.html-to-image",
    descriptionKey: "op.render.html-to-image.desc",
    inputFormats: ["html"],
    outputFormats: ["png", "tiff"],
  ...
  },
  {
    id: "office:convert",
    category: "document",
    labelKey: "op.office.convert",
    descriptionKey: "op.office.convert.desc",
    inputFormats: ["docx", "doc", "odt", "rtf", "pptx", "ppt", "odp"],
    outputFormats: ["odt", "docx", "rtf", "pptx"],
