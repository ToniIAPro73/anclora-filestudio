export const ERROR_CODES = {
  ...
  YOUTUBE_FORMAT_DELIVERY_403: 'YOUTUBE_FORMAT_DELIVERY_403',
  YOUTUBE_GENERIC_ACCESS_DENIED: 'YOUTUBE_GENERIC_ACCESS_DENIED',
...
export const ERROR_MESSAGES: Record<ErrorCode, string> = {
  ...
  YOUTUBE_LOGIN_REQUIRED: 'El vídeo requiere iniciar sesión en YouTube para verse (contenido privado, restringido por edad o con acceso limitado). No se puede descargar sin una cuenta autorizada.',
  YOUTUBE_FORMAT_DELIVERY_403: 'YouTube ha denegado la entrega de una representación concreta del vídeo (HTTP 403 en el CDN). Se reintenta automáticamente con una representación alternativa.',
  YOUTUBE_GENERIC_ACCESS_DENIED: 'YouTube ha denegado el acceso (HTTP 403). Puede ser temporal o requerir configuración adicional.',
